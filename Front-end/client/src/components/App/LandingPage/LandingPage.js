    ...
    <Grid style={{ justifyContent: "center" }} stackable>
      <Grid.Row
        ...
        <div style={{ backgroundColor: "white", padding: "2em" }}>
          <span
            className="app-name"
            style={{ color: "#37bc9b", paddingRight: "0.2em" }}>
            GOOD
          </span>
      ...
      <Grid.Row className="about-section" centered columns="equal">
        <Grid.Column width={1}>
          <Icon name="newspaper outline" size="huge" color="grey" />
        </Grid.Column>
        <Grid.Column className="about-app">
          You can get news from a variety of sources without having to deal with
          clickbait.
        </Grid.Column>
        <Grid.Column width={1}>
        ...
        <Grid.Column className="about-app">
          We used machine learning to identify clickbait articles so you just
          get the news.
        </Grid.Column>
        <Grid.Column width={1}>
        ...
        <Grid.Column className="about-app">
          Created by a team of Data Science and Web Development students at
          Lambda School.
        </Grid.Column>
      </Grid.Row>
      <Grid.Row centered>
