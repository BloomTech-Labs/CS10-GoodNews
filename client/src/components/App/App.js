...
class App extends Component {
  ...
  switchModals = modal => {
    switch (modal) {
      case "signIn":
        return (
          <SignIn toggleModal={this.toggleModal} login={this.isLoggedIn} />
        );
      case "register":
        return (
          <Register toggleModal={this.toggleModal} login={this.isLoggedIn} />
        );
      case "settings":
        return (
          <Settings
          ...
          <MainMenu
            searchBar={
              <Search
                ...
                onSearchChange={debounce(this.handleSearchChange, {
                  leading: true,
                })}
